            ...
            <div class="row g-0">
              ...
              <div class="col-xl-6 d-none d-xl-block text-center">
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <img style="width: 400px" class="img-account-profile rounded-circle mb-2" src="{{asset('profile/'.$user['profile'])}}"  alt="">
              ...
              <div class="col-xl-6">
                <div class="card-body p-md-5 text-black">
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="First_name" name="First_name" value="{{$user->First_name}}" class="form-control form-control-lg"  />
                        <label class="form-label" for="First_name">First name</label>
                      </div>
                    </div>
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="text" id="Last_name" name="Last_name" value="{{$user->Last_name}}" class="form-control form-control-lg" />
                  ...
                  <div class="form-outline mb-4">
                    <input type="text" id="contact" name="contact" value="{{$user->contact}}" class="form-control form-control-lg" />
                    <label class="form-label" for="contact">Contact</label>
                  </div>

                  <div class="form-outline mb-4">
                    <input type="text" id="address" name="address" value="{{$user->address}}" class="form-control form-control-lg" />
